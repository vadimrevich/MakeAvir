...
rem This Script will Register a Schedule Task for 
...
%SCHEDEXE% /CREATE /Sc ONSTART /Tn %SCHTASKNAME% /Tr %SCHWSFCMD% /Ru system /DELAY 0002:00 /F
if %errorlevel% neq 0 goto Error_Sched
goto End

:Error_Sched
echo Error at Script %0! Task is not Created
exit /b 2
