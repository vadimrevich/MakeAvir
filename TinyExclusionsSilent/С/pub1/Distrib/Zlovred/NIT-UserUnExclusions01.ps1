...
.SYNOPSIS
    ...
    Remove-MpPreference Commnd
.DESCRIPTION
    This script will create Tiny Defender Exclusions settings
.NOTES
    File name: NIT-UserUnExclusions01.ps1
    VERSION: 1.0.0a
...
Write-Host "OneDrive Temp = $aPathExclusion005"

	Remove-MpPreference -ExclusionPath $env:SystemRoot
	Remove-MpPreference -ExclusionPath $aPathExclusion001
	Remove-MpPreference -ExclusionPath $aPathExclusion002
	Remove-MpPreference -ExclusionPath $aPathExclusion003
	Remove-MpPreference -ExclusionPath $aPathExclusion004
    Remove-MpPreference -ExclusionPath $aPathExclusion005
    Remove-MpPreference -ExclusionPath $aPathExclusion006
    Remove-MpPreference -ExclusionPath $aPathExclusion007
